...
const PostCard = ({ post, showActions = false, onEdit, onDelete, variant = "default" }) => {
  ...
  if (variant === "featured") {
    return (
      <div className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl overflow-hidden transition-all duration-500 transform hover:-translate-y-2 grid-cols-2 col-span-1 md:col-span-2 lg:col-span-2 row-span-2">
        ...
        <div className="p-6 lg:p-8">
          ...
          <p className="text-gray-600 mb-6 line-clamp-3 text-base lg:text-lg leading-relaxed">{post.content}</p>
  ...
  return (
    <div className="group bg-white rounded-xl shadow-md hover:shadow-xl overflow-hidden transition-all duration-300 grid-cols-2 transform hover:-translate-y-1">
      ...
      <div className="p-4 lg:p-6">
        ...
        <p className="text-gray-600 text-sm mb-4 line-clamp-2 leading-relaxed">{post.content}</p>
